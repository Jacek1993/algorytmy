...
public class Projekt1 {
    private static BaseNode[][] baseNodes = new BaseNode[3][4];
...
//        int[][] solekMatolek4 = new int[5][5];
//
//        solekMatolek4[0][0] = 1;solekMatolek4[0][1] = 2;solekMatolek4[0][2] = 5;solekMatolek4[0][3] = 3;solekMatolek4[0][4] = 0;
//        solekMatolek4[1][0] = 6;solekMatolek4[1][1] = 0;solekMatolek4[1][2] = -1;solekMatolek4[1][3] = 0;solekMatolek4[1][4] = 0;
//        solekMatolek4[2][0] = 7;solekMatolek4[2][1] = 10;solekMatolek4[2][2] = 0;solekMatolek4[2][3] = 1;solekMatolek4[2][4] = -5;
//        solekMatolek4[3][0] = 0;solekMatolek4[3][1] = 0;solekMatolek4[3][2] = 0;solekMatolek4[3][3] = 0;solekMatolek4[3][4] = -2;
//        solekMatolek4[4][0] = 11;solekMatolek4[4][1] = 12;solekMatolek4[4][2] = 2;solekMatolek4[4][3] = 0;solekMatolek4[4][4] = 0;
//
//        System.out.println("\n\n");
//        findCircleSolka(solekMatolek4);
//        System.out.println("\n\n");
//        System.out.println(minimumSolka(solekMatolek4));

//        int[][] solekMatolek5 = new int[5][5];
//
//        solekMatolek5[0][0] = 2;solekMatolek5[0][1] = 0;solekMatolek5[0][2] = 2;solekMatolek5[0][3] = 0;solekMatolek5[0][4] = 2;
//        solekMatolek5[1][0] = 0;solekMatolek5[1][1] = 0;solekMatolek5[1][2] = 2;solekMatolek5[1][3] = 2;solekMatolek5[1][4] = 2;
//        solekMatolek5[2][0] = 0;solekMatolek5[2][1] = 2;solekMatolek5[2][2] = 2;solekMatolek5[2][3] = -5;solekMatolek5[2][4] = 2;
//        solekMatolek5[3][0] = 2;solekMatolek5[3][1] = 2;solekMatolek5[3][2] = 2;solekMatolek5[3][3] = 2;solekMatolek5[3][4] = 2;
//        solekMatolek5[4][0] = 2;solekMatolek5[4][1] = 2;solekMatolek5[4][2] = 2;solekMatolek5[4][3] = 2;solekMatolek5[4][4] = 2;
//
//        System.out.println("\n\n");
//        findCircleSolka(solekMatolek5);
//        System.out.println("\n\n");
//        System.out.println(minimumSolka(solekMatolek5));

//                int[][] solekMatolek5 = new int[3][4];
//
//        solekMatolek5[0][0] = 0;solekMatolek5[0][1] = 0;solekMatolek5[0][2] = -10;solekMatolek5[0][3] = -2;
//        solekMatolek5[1][0] = 8;solekMatolek5[1][1] = 0;solekMatolek5[1][2] = 0;solekMatolek5[1][3] = 0;
//        solekMatolek5[2][0] = 1;solekMatolek5[2][1] = -1;solekMatolek5[2][2] = -18;solekMatolek5[2][3] = 0;

        int[][] solekMatolek5 = new int[3][4];

        solekMatolek5[0][0] = 0;solekMatolek5[0][1] = 0;solekMatolek5[0][2] = 1;solekMatolek5[0][3] = 0;
        solekMatolek5[1][0] = 8;solekMatolek5[1][1] = 0;solekMatolek5[1][2] = 0;solekMatolek5[1][3] = 6;
        solekMatolek5[2][0] = -1;solekMatolek5[2][1] = -3;solekMatolek5[2][2] = -9;solekMatolek5[2][3] = 0;
    ...
    private static SolekPoint minimumSolka(int[][] xArray) {
        ...
        for (int i = 0; i < xArray.length; i++) {
            for (int j = 0; j < xArray[0].length; j++) //może j<fieldArray.GetLength(1)
            {
                ...
                if ( xArray[i][j] <0 && xArray[i][j] < minimalnaWartosc) {
